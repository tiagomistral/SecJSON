...
function decryptKeyInfo(doc, options) {
  ...
  var keyInfo = doc.EncryptedData.EncryptedKey.KeyInfo;
  var keyEncryptionAlgorighm = doc.EncryptedData.EncryptedKey.EncryptionMethod.Algorithm;
  var encryptedKey = doc.EncryptedData.EncryptedKey.CipherData.CipherValue;
